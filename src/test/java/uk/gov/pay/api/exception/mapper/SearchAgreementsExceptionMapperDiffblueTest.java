...
class SearchAgreementsExceptionMapperDiffblueTest {
  /**
   * Test {@link SearchAgreementsExceptionMapper#toResponse(SearchAgreementsException)} with {@code
   * exception}.
   *
   * <ul>
   ...
   * SearchAgreementsExceptionMapper#toResponse(SearchAgreementsException)}
   */
  @Test
  @DisplayName(
      "Test toResponse(SearchAgreementsException) with 'exception'; then return Status is five hundred")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Response SearchAgreementsExceptionMapper.toResponse(SearchAgreementsException)"
  })
  void testToResponseWithException_thenReturnStatusIsFiveHundred() {
    // Arrange
    SearchAgreementsExceptionMapper searchAgreementsExceptionMapper =
        new SearchAgreementsExceptionMapper();

    // Act
    Response actualToResponseResult =
        searchAgreementsExceptionMapper.toResponse(
  ...
  @Test
  @DisplayName(
      "Test toResponse(SearchAgreementsException) with 'exception'; then return Status is four hundred four")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "Response SearchAgreementsExceptionMapper.toResponse(SearchAgreementsException)"
