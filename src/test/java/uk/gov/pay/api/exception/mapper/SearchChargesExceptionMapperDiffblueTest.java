...
class SearchChargesExceptionMapperDiffblueTest {
  /**
   * Test {@link SearchChargesExceptionMapper#toResponse(SearchPaymentsException)} with {@code
   * exception}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link SearchChargesExceptionMapper#toResponse(SearchPaymentsException)}
   */
  @Test
  @DisplayName(
      "Test toResponse(SearchPaymentsException) with 'exception'; then return Status is five hundred")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Response SearchChargesExceptionMapper.toResponse(SearchPaymentsException)"})
  void testToResponseWithException_thenReturnStatusIsFiveHundred() {
    // Arrange
    SearchChargesExceptionMapper searchChargesExceptionMapper = new SearchChargesExceptionMapper();

    // Act
    Response actualToResponseResult =
        searchChargesExceptionMapper.toResponse(
  ...
  @Test
  @DisplayName(
      "Test toResponse(SearchPaymentsException) with 'exception'; then return Status is four hundred four")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"Response SearchChargesExceptionMapper.toResponse(SearchPaymentsException)"})
